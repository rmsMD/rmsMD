...
```{r}
# Generate a model summary with custom styling options & store as summary_custom
...
```{r}
# Fit a logistic regression model including a restricted cubic spline for Age (with 4 knots)
fit_lrm <- lrm(
        majorcomplication ~ 
                ...
                data = data,
                x = TRUE, y = TRUE   # allows subsequent LR tests for lrm and cph          
)
