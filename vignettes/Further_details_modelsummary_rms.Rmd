...
# Fit a logistic regression model using the rms package with an interaction between Age and smoking status.
fit_lrm_interaction <- lrm(majorcomplication ~ age*smoking + rcs(bmi,4) + sex + smoking, data = data)
